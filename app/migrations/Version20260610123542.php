 ...
 */
final class Version20260610123542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clicks (id BINARY(16) NOT NULL, ip VARCHAR(45) DEFAULT NULL, user_agent LONGTEXT DEFAULT NULL, referer LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, url_id BINARY(16) NOT NULL, INDEX IDX_20DA190181CFDAE7 (url_id), INDEX idx_created_at (created_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
